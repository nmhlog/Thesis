#!/bin/bash
echo "down_sampling"
cp crossvalidation/100/100cv5prepare_data_inst_instance_stpls3d.py 100cv5prepare_data_inst_instance_stpls3d.py
...
zip data_cv5_100.zip val_cv5_100 traincv5_100_100/ traincv5_100_50/ note_weighttraincv5_100_50.txt note_weighttraincv5_100_100.txt
