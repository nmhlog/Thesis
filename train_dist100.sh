...
CUDA_VISIBLE_DEVICES=1,2,3,4 bash dist_train-only_semantic.sh configs/training_only_semantic_segmentation/100x100_50/semantic_unet_100x50.yaml4 
...
CUDA_VISIBLE_DEVICES=1,2,3,4 bash dist_train_HAIS.sh configs/training_backbone/100x100_50/unet_100x50_ASPPv2.yaml 4 
