...
CUDA_VISIBLE_DEVICES=2 python train_semantic_segmentation_model.py configs/cross_validation/5050/cv5_5050_semantic_unet.yaml
CUDA_VISIBLE_DEVICES=2 python train_semantic_segmentation_model.py configs/cross_validation/5050/cv5_5050_semantic_unet_ASPPv2.yaml
CUDA_VISIBLE_DEVICES=2 python train_semantic_segmentation_model.py configs/cross_validation/5050/cv5_5050_semantic_unet_ATTN_ASPP.yaml
