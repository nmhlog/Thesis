...
from evaluation import (evaluate_semantic_acc,evaluate_semantic_miou)
from model import semantic_segmentation_model
...
def get_args():
    parser = argparse.ArgumentParser('semantic_segmentation_model')
    parser.add_argument('config', type=str, help='path to config file')
    parser.add_argument('--dist', action='store_true', help='run with distributed parallel')
    parser.add_argument('--resume', type=str, help='path to resume from')
    parser.add_argument('--work_dir', type=str, help='working directory')
    parser.add_argument('--skip_validate', action='store_true',default=False, help='skip validation')
...
def main():
    ...
    # model
    model = semantic_segmentation_model(**cfg.model).cuda()
    if args.dist:
