...
#define MAX_PRIMARY_NUM 4096
#define MAX_PER_PRIMARY_ABSORB_FRAGMENT_NUM  4096
...
__global__ void fragment_find_primary_(int primary_num, int *cuda_primary_offsets, float *cuda_primary_centers,
    ...
    float class_radius_mean[15] = {-1., 13.12, 2.01, 2.68, 7.48, 2.75, 3.91, 7.76, 4.15, 2.32, 1.56, 5.24, 2.53, 2.21, 10.51};
