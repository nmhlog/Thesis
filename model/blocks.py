...
class ASPP(SparseModule):
    def __init__(self,in_channels, out_channels, norm_fn, block_reps=2, indice_key=6, rate = [6, 12, 18]):
        ...
        self.aspp_block2 = ResidualBlock( in_channels, out_channels, norm_fn, padding=rate[1], dilation=rate[0], indice_key='bb_subm{}'.format(indice_key))
        
      
        self.aspp_block3 = ResidualBlock( in_channels, out_channels, norm_fn, padding=rate[2], dilation=rate[0], indice_key='bb_subm{}'.format(indice_key))
