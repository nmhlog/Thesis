...
from lib.softgroup_ops.functions import ballquery_batch_p, bfs_cluster, get_mask_iou_on_cluster, get_mask_iou_on_pred,get_mask_label,global_avg_pool, sec_max, sec_min, voxelization,voxelization_idx
# from SOFTGROUP_OP import ballquery_batch_p, bfs_cluster, get_mask_iou_on_cluster, get_mask_iou_on_pred,get_mask_label,global_avg_pool, sec_max, sec_min, voxelization,voxelization_idx
...
class SoftGroup(nn.Module):
    ...
    def forward_train(self, batch_idxs, voxel_coords, p2v_map, v2p_map, coords_float, feats,
        ...
        semantic_scores, output_feats = self.forward_backbone(input, v2p_map)
    ...
    def forward_test(self, batch_idxs, voxel_coords, p2v_map, v2p_map, coords_float, feats,
        ...
        voxel_feats = voxelization(feats, p2v_map)
        input = spconv.SparseConvTensor(voxel_feats, voxel_coords.int(), spatial_shape, batch_size)
        semantic_scores, output_feats = self.forward_backbone(
    ...
    def forward_backbone(self, input, input_map, x4_split=False):
        ...
        return semantic_scores, output_feats
