...
CUDA_VISIBLE_DEVICES=2 python train_semantic_segmentation_model.py configs/training_only_semantic_segmentation/100x100/semantic_unet_100x100.yaml --resume work_dirs/semantic_unet_100x100/epoch_26.pth
