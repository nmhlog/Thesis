...
CUDA_VISIBLE_DEVICES=3,4,5,6 python train_semantic_segmentation_model.py configs/training_only_semantic_segmentation/50x50_25/semantic_unet_50x25_ATTN_ASPP.yaml 4 
