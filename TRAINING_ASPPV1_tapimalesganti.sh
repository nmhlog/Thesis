...
CUDA_VISIBLE_DEVICES=1,3,4,5 bash dist_train_HAIS.sh configs/training_backbone/50x50_50/unet_ATTN_ASPP.yaml 4 
echo "Training Instance"
echo "Training HAIS_stpls3d_unet_ATTN_ASPP" 
CUDA_VISIBLE_DEVICES=1,3,4,5 bash dist_train_HAIS.sh configs/training_all/50X50_50/HAIS_stpls3d_unet_ATTN_ASPP.yaml 4
...
echo "Training Backbone"
echo "Training unet_ATTN_ASPP"
CUDA_VISIBLE_DEVICES=1,3,4,5 bash dist_train_HAIS.sh configs/training_backbone/50x50_25/unet_50x25_ATTN_ASPP.yaml 4 
echo "Training Instance"
echo "Training HAIS_stpls3d_unet_ATTN_ASPP" 
CUDA_VISIBLE_DEVICES=1,3,4,5 bash dist_train_HAIS.sh configs/training_all/50x50_25/HAIS_stpls3d_unet_ATTN_ASPP_50x25.yaml 4
